...
def RunCommand(is_interactive):
    """Run the AdjustCSPlanePositions command."""
    try:
        from plugin.commands.parameterization_commands import AdjustCSPlanePositions
        cmd = AdjustCSPlanePositions()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AdjustCSPlanePositions: {0}".format(ex)
        )
        return 1
