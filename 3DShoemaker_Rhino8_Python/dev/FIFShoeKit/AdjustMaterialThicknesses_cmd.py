...
def RunCommand(is_interactive):
    """Run the AdjustMaterialThicknesses command."""
    try:
        from plugin.commands.parameterization_commands import AdjustMaterialThicknesses
        cmd = AdjustMaterialThicknesses()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AdjustMaterialThicknesses: {0}".format(ex)
        )
        return 1
