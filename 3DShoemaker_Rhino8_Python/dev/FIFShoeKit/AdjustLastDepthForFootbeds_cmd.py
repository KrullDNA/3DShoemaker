...
def RunCommand(is_interactive):
    """Run the AdjustLastDepthForFootbeds command."""
    try:
        from plugin.commands.parameterization_commands import AdjustLastDepthForFootbeds
        cmd = AdjustLastDepthForFootbeds()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AdjustLastDepthForFootbeds: {0}".format(ex)
        )
        return 1
