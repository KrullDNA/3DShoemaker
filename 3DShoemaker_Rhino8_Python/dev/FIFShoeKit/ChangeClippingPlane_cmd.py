...
def RunCommand(is_interactive):
    """Run the ChangeClippingPlane command."""
    try:
        from plugin.commands.export_commands import ChangeClippingPlane
        cmd = ChangeClippingPlane()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] ChangeClippingPlane: {0}".format(ex)
        )
        return 1
