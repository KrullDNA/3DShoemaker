...
def RunCommand(is_interactive):
    """Run the AdjustFootbedDepth command."""
    try:
        from plugin.commands.parameterization_commands import AdjustFootbedDepth
        cmd = AdjustFootbedDepth()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AdjustFootbedDepth: {0}".format(ex)
        )
        return 1
