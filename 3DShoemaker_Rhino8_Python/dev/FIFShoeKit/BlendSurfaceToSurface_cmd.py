...
def RunCommand(is_interactive):
    """Run the BlendSurfaceToSurface command."""
    try:
        from plugin.commands.editing_commands import BlendSurfaceToSurface
        cmd = BlendSurfaceToSurface()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] BlendSurfaceToSurface: {0}".format(ex)
        )
        return 1
