...
def RunCommand(is_interactive):
    """Run the OpenFIFShoeKitOptions command."""
    try:
        from plugin.commands.export_commands import OpenFIFShoeKitOptions
        cmd = OpenFIFShoeKitOptions()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] OpenFIFShoeKitOptions: {0}".format(ex)
        )
        return 1
