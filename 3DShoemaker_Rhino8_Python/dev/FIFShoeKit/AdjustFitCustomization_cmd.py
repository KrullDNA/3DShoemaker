...
def RunCommand(is_interactive):
    """Run the AdjustFitCustomization command."""
    try:
        from plugin.commands.parameterization_commands import AdjustFitCustomization
        cmd = AdjustFitCustomization()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AdjustFitCustomization: {0}".format(ex)
        )
        return 1
