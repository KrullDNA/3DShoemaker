...
def RunCommand(is_interactive):
    """Run the SnapCurves command."""
    try:
        from plugin.commands.export_commands import SnapCurvesCommand
        cmd = SnapCurvesCommand()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] SnapCurves: {0}".format(ex)
        )
        return 1
