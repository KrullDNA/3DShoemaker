...
def RunCommand(is_interactive):
    """Run the NewMorphScriptable command."""
    try:
        from plugin.commands.morph_commands import NewMorphScriptable
        cmd = NewMorphScriptable()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] NewMorphScriptable: {0}".format(ex)
        )
        return 1
