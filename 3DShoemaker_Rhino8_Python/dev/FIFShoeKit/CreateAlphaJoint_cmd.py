...
def RunCommand(is_interactive):
    """Run the CreateAlphaJoint command."""
    try:
        from plugin.commands.component_commands import CreateAlphaJoint
        cmd = CreateAlphaJoint()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] CreateAlphaJoint: {0}".format(ex)
        )
        return 1
