...
def RunCommand(is_interactive):
    """Run the ChangeInsertParameterization command."""
    try:
        from plugin.commands.parameterization_commands import ChangeInsertParameterization
        cmd = ChangeInsertParameterization()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] ChangeInsertParameterization: {0}".format(ex)
        )
        return 1
