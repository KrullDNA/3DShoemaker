...
def RunCommand(is_interactive):
    """Run the ImportParameters command."""
    try:
        from plugin.commands.last_commands import ImportParameters
        cmd = ImportParameters()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] ImportParameters: {0}".format(ex)
        )
        return 1
