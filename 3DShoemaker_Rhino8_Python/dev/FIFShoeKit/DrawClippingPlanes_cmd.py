...
def RunCommand(is_interactive):
    """Run the DrawClippingPlanes command."""
    try:
        from plugin.commands.view_commands import DrawClippingPlanes
        cmd = DrawClippingPlanes()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] DrawClippingPlanes: {0}".format(ex)
        )
        return 1
