...
def RunCommand(is_interactive):
    """Run the ExportMeasurementEquations command."""
    try:
        from plugin.commands.last_commands import ExportMeasurementEquations
        cmd = ExportMeasurementEquations()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] ExportMeasurementEquations: {0}".format(ex)
        )
        return 1
