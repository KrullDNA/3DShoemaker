...
def RunCommand(is_interactive):
    """Run the VacuumForm command."""
    try:
        from plugin.commands.export_commands import VacuumFormCommand
        cmd = VacuumFormCommand()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] VacuumForm: {0}".format(ex)
        )
        return 1
