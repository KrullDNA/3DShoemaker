# -*- coding: utf-8 -*-
"""Open the foot import dialog (alternative entry point to ImportFoot).

Supports STL, OBJ, PLY, 3MF, XYZ, PTS, CSV and other scan formats.
...
def _import_point_cloud_file(doc, file_path, layer_index):
    """Import a point-cloud text file into doc."""
    points = []
...
def RunCommand(is_interactive):
    ...
    Rhino.RhinoApp.WriteLine("Opening foot scan import dialog ...")
    ...
    filter_str = "All Supported|{0}|All Files|*.*".format(all_exts)
