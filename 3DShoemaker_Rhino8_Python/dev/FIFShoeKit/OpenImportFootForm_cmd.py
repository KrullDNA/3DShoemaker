...
def RunCommand(is_interactive):
    """Run the OpenImportFootForm command."""
    try:
        from plugin.commands.foot_commands import OpenImportFootForm
        cmd = OpenImportFootForm()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] OpenImportFootForm: {0}".format(ex)
        )
        return 1
