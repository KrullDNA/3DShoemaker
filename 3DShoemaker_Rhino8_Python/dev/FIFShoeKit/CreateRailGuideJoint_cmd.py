...
def RunCommand(is_interactive):
    """Run the CreateRailGuideJoint command."""
    try:
        from plugin.commands.component_commands import CreateRailGuideJoint
        cmd = CreateRailGuideJoint()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] CreateRailGuideJoint: {0}".format(ex)
        )
        return 1
