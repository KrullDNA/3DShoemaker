...
def RunCommand(is_interactive):
    """Run the CreateUpperBodies command."""
    try:
        from plugin.commands.component_commands import CreateUpperBodies
        cmd = CreateUpperBodies()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] CreateUpperBodies: {0}".format(ex)
        )
        return 1
