...
def RunCommand(is_interactive):
    """Run the AdjustOrthoticArchHeightAndLength command."""
    try:
        from plugin.commands.orthotic_commands import AdjustOrthoticArchHeightAndLength
        cmd = AdjustOrthoticArchHeightAndLength()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AdjustOrthoticArchHeightAndLength: {0}".format(ex)
        )
        return 1
