...
def RunCommand(is_interactive):
    """Run the ExportSupportParameters command."""
    try:
        from plugin.commands.export_commands import ExportSupportParameters
        cmd = ExportSupportParameters()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] ExportSupportParameters: {0}".format(ex)
        )
        return 1
