...
def RunCommand(is_interactive):
    """Run the PrintPrepOrthotics command."""
    try:
        from plugin.commands.orthotic_commands import PrintPrepOrthotics
        cmd = PrintPrepOrthotics()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] PrintPrepOrthotics: {0}".format(ex)
        )
        return 1
