...
def RunCommand(is_interactive):
    ...
    _add_component(doc, shank_brep, CLASS_BOTTOM, "SLM_ShankBoard")

    Rhino.RhinoApp.WriteLine(
        "[Feet in Focus Shoe Kit] Shank board created: {0}mm x {1:.1f}mm x {2}mm.".format(
            width, shank_length, thickness
        )
    )
