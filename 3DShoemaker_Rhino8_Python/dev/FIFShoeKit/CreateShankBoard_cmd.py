...
def RunCommand(is_interactive):
    """Run the CreateShankBoard command."""
    try:
        from plugin.commands.component_commands import CreateShankBoard
        cmd = CreateShankBoard()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] CreateShankBoard: {0}".format(ex)
        )
        return 1
