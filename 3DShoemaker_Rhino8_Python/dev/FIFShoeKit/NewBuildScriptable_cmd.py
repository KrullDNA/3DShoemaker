...
def RunCommand(is_interactive):
    """Run the NewBuildScriptable command."""
    try:
        from plugin.commands.last_commands import NewBuildScriptable
        cmd = NewBuildScriptable()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] NewBuildScriptable: {0}".format(ex)
        )
        return 1
