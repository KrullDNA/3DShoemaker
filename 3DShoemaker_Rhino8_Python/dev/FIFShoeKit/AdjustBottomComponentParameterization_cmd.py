...
def RunCommand(is_interactive):
    """Run the AdjustBottomComponentParameterization command."""
    try:
        from plugin.commands.parameterization_commands import AdjustBottomComponentParameterization
        cmd = AdjustBottomComponentParameterization()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AdjustBottomComponentParameterization: {0}".format(ex)
        )
        return 1
