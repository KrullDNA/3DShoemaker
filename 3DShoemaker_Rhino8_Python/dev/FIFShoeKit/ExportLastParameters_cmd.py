...
def RunCommand(is_interactive):
    """Run the ExportLastParameters command."""
    try:
        from plugin.commands.last_commands import ExportLastParameters
        cmd = ExportLastParameters()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] ExportLastParameters: {0}".format(ex)
        )
        return 1
