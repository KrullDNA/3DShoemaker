...
def RunCommand(is_interactive):
    """Run the AnalyzePlantarFootScan command."""
    try:
        from plugin.commands.foot_commands import AnalyzePlantarFootScan
        cmd = AnalyzePlantarFootScan()
        ...
        Rhino.RhinoApp.WriteLine(
            "[Feet in Focus Shoe Kit] AnalyzePlantarFootScan: {0}".format(ex)
        )
        return 1
